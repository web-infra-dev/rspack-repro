...
__webpack_require__.d(__webpack_exports__, {
  decorateDefaultCredentialProvider: () => (/* binding */ defaultRoleAssumers_decorateDefaultCredentialProvider)
});

// UNUSED EXPORTS: getDefaultRoleAssumer, getDefaultRoleAssumerWithWebIdentity
...
class models_0_InvalidAuthorizationMessageException extends STSServiceException {
    constructor(opts) {
        super({
...
const de_Credentials = (output, context) => {
    ...
    if (output[_STe] != null) {
        contents[_STe] = (0,smithy_client_dist_es.expectString)(output[_STe]);
    }
    if (output[_E] != null) {
...
var resolveAwsSdkSigV4Config = __webpack_require__("./node_modules/@aws-sdk/core/dist-es/httpAuthSchemes/aws_sdk/resolveAwsSdkSigV4Config.js");
...
var AwsSdkSigV4Signer = __webpack_require__("./node_modules/@aws-sdk/core/dist-es/httpAuthSchemes/aws_sdk/AwsSdkSigV4Signer.js");
...
const runtimeConfig_getRuntimeConfig = (config) => {
    ...
    return {
        ...
        credentialDefaultProvider: config?.credentialDefaultProvider ?? decorateDefaultCredentialProvider(credential_provider_node_dist_es.defaultProvider),
        ...
        httpAuthSchemes: config?.httpAuthSchemes ?? [
            {
                schemeId: "aws.auth#sigv4",
                identityProvider: (ipc) => ipc.getIdentityProvider("aws.auth#sigv4") ||
                    (async (idProps) => await decorateDefaultCredentialProvider(credential_provider_node_dist_es.defaultProvider)(idProps?.__config || {})()),
                signer: new AwsSdkSigV4Signer.AwsSdkSigV4Signer(),
            },
            {
                schemeId: "smithy.api#noAuth",
...
class STSClient extends smithy_client_dist_es.Client {
    constructor(...[configuration]) {
        ...
        const _config_3 = (0,dist_es.resolveEndpointConfig)(_config_2);
